...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('uid', models.AutoField(serialize=False, primary_key=True)),
                ('date', models.DateField(default=datetime.datetime(2015, 7, 1, 15, 48, 14, 859000))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_time', models.DateTimeField(default=datetime.datetime(2015, 7, 1, 15, 48, 14, 860000))),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.datetime(2015, 7, 1, 15, 48, 14, 855000))),
