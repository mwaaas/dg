...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VideosAdopted.s3url'
        db.add_column(u'IVR_videosadopted', 's3url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VideosAdopted.s3url'
        db.delete_column(u'IVR_videosadopted', 's3url')
    ...
    models = {
        u'IVR.videosadopted': {
            ...
            's3url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
