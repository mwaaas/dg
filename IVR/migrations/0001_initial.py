...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VideosAdopted'
        db.create_table(u'IVR_videosadopted', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Person'])),
            ('mobile_no', self.gf('django.db.models.fields.CharField')(max_length=12, null=True)),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video'])),
            ('watch_at', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('survey_at', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('has_seen', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('has_adopted', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('recording_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'IVR', ['VideosAdopted'])


    def backwards(self, orm):
        # Deleting model 'VideosAdopted'
        db.delete_table(u'IVR_videosadopted')


    models = {
        u'IVR.videosadopted': {
            'Meta': {'object_name': 'VideosAdopted'},
            'has_adopted': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'has_seen': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mobile_no': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['people.Person']"}),
            'recording_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'survey_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['videos.Video']"}),
            'watch_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'})
        },
        u'auth.group': {
