...
class VideoAdmin(admin.ModelAdmin):
    fieldsets = [
                (None, {'fields':['title','video_type','video_production_start_date','video_production_end_date','language','storybase','summary', 'partner', 'related_practice','s3url']}),
...
class IVRAdmin(admin.ModelAdmin):
    ...
    raw_id_fields = ('person', 'video')
    list_display = ('id','video','person_id','person','video_id','video','ivr_call')
